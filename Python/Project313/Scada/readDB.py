...
# “solo ejecuta este código si el archivo se está corriendo directamente, no cuando se importa como módulo”
# 4. Main program check
if __name__ == '__main__': # Main program check, ejecuted when the module is run directly
    datos = readDB() # call the readDB function
    print(datos) # print the returned data from readDB function (Muestra en consola lo que devolvió la función)
